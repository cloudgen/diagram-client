# Gradle Build Steps for diagram-client

This document explains how to build and run the **diagram-client** project using **Gradle** with the provided `build.gradle` configuration.
...
- Place the final binary in `target/debug/diagram-client`
...
- Place the executable at: **`target/debug/diagram-client`**
...
- **Binary**: `target/debug/diagram-client`
