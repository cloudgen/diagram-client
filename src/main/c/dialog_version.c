...
//   - Show both PROJECT_NAME and version for better user experience.
// 
// Protection Rule:
...
void on_show_version_activate(GtkMenuItem *menu_item, gpointer user_data)
{
    ...
    gchar *message = g_strdup_printf(
        "<big><b>%s</b></big>\n\n"
        "Version: <b>%d.%d.%d</b>\n\n"
        "A lightweight native web-based client built with WebKitGTK.",
        PROJECT_NAME,
        VERSION_MAJOR,
        VERSION_MINOR,
        VERSION_PATCH
    ...
    ciao_debug("Version dialog displayed: %s %d.%d.%d", 
